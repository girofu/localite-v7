...
interface LearningSheetsListScreenProps {
  onClose: () => void;
...
export default function LearningSheetsListScreen({ onClose, onNavigate }: LearningSheetsListScreenProps) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.dashedBox}>
          <Text style={styles.noRecordsText}>目前尚無學習記錄</Text>
        </View>
