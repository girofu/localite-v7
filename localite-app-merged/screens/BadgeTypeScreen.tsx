...
export default function BadgeTypeScreen({ onClose, onNavigate, badgeType, isLoggedIn = false }: BadgeTypeScreenProps) {
  ...
  const getBadgesForType = (): Badge[] => {
    if (badgeType === '分享成就') {
      ...
      return (BADGES_BY_TYPE as Record<string, Badge[]>)[badgeType] || [];
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity 
          ...
          onPress={() => onNavigate('drawerNavigation')}
          testID="menu-button"
        >
      ...
      {!isLoggedIn ? (
        ...
        <View style={styles.contentContainer}>
          {/* Lock Icon */}
          <View style={styles.bigLockIconContainer}>
            <Image source={require('../assets/icons/icon_lockman.png')} style={styles.bigLockIcon} />
          </View>
