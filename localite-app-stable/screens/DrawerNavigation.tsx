        ...
        >
          <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.menuContainer} showsVerticalScrollIndicator={false}>
              ...
              {/* 我的徽章 */}
              <TouchableOpacity style={styles.menuItem} onPress={onNavigateToBadge}>
              ...
              {/* 關於 Localite AI */}
              <TouchableOpacity style={styles.menuItem} onPress={onNavigateToAboutLocalite}>
                <Image source={require('../assets/icons/icon_website.png')} style={styles.menuIcon} />
                <Text style={styles.menuText}>關於 Localite AI</Text>
              </TouchableOpacity>
            </ScrollView>
